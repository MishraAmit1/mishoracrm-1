...
<title>Privacy Policy — CrmPro</title>
...
<div class="wrap">
    ...
    <a href="{{ route('home') }}" class="back">← CrmPro</a>
    <h1>Privacy Policy</h1>
    <div class="updated">Last updated: {{ now()->format('F d, Y') }}</div>

    <p>This Privacy Policy explains how <strong>CrmPro</strong> ("we", "us", "our") collects, uses, and protects
    ...
    <p>CrmPro is a business tool and is not directed at, or knowingly used by, children under 16.</p>
