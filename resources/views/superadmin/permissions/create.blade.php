    ...
    <div class="form-card">
        ...
        <form action="{{ route('superadmin.permissions.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="module" id="module-input" value="{{ old('module') }}"
                ...
                <div class="form-hint">Pick an existing module from the list, or type a new one — new modules show up automatically, no code changes needed.</div>
                @error('module')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>

            <div class="form-group">
                <label class="form-label">Action <span class="req">*</span></label>
                <input type="text" name="action" id="action-input" value="{{ old('action') }}"
            ...
            <div class="form-group">
                ...
                <div class="name-preview" id="name-preview">module.action</div>
                <div class="form-hint">This permission is automatically granted to the Tenant Admin role on save.</div>
            </div>
