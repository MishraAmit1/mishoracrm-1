<aside class="sidebar" id="sidebar">
    ...
    <div class="sb-body">
        ...
        <a href="{{ route('tenant.leads.index') }}"
           class="sb-item {{ request()->routeIs('leads.*') ? 'active' : '' }}">
            <span class="sb-icon">
                <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
        ...
        <a href="{{ route('tenant.contacts.index') }}" <a href="#"
        ...
        <button type="button"
                class="sb-item {{ request()->routeIs('whatsapp.*','email.*') ? 'sub-open' : '' }}"
        ...
        <div class="sb-sub {{ request()->routeIs('whatsapp.*','email.*') ? 'open' : '' }}"
             id="sub-comm">
            <a href="{{ route('tenant.whatsapp.index') }}" 
               class="sb-item {{ request()->routeIs('whatsapp.*') ? 'active' : '' }}">
                <span class="sb-icon">
                    <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
