...
<div class="page-head">
    ...
    <a href="{{ route('tenant.contacts.index') }}" class="btn btn-secondary">Back</a>
</div>
...
<div class="imp-card">
    <form method="POST" action="{{ route('tenant.contacts.import.preview') }}" enctype="multipart/form-data" id="importForm">
        @csrf
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-top:20px">
            <a href="{{ route('tenant.contacts.import.template') }}" class="btn btn-secondary" style="font-size:12.5px">
                Download sample CSV
            </a>
...
<div class="imp-card" style="margin-top:16px">
    ...
    <ul style="margin:0;padding-left:18px;color:var(--text-300);font-size:12.5px;line-height:1.8">
        ...
        <li>Rows matching an existing contact's phone or email are skipped automatically (not duplicated).</li>
