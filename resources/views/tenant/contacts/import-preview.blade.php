@extends('layouts.app')
@section('title', 'Map Columns — Import Contacts')
...
<div class="page-head">
    <div>
        ...
        <div class="page-sub">Tell us which file column goes to which contact field.</div>
    </div>
    <a href="{{ route('tenant.contacts.import') }}" class="btn btn-secondary">Start over</a>
</div>
...
<form method="POST" action="{{ route('tenant.contacts.import.confirm') }}" id="mapForm">
    @csrf
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-top:20px">
        <div style="font-size:12.5px;color:var(--text-300)">Rows matching an existing contact's phone/email will be skipped.</div>
        <button type="submit" class="btn btn-primary" id="confirmBtn">Import Contacts</button>
    </div>
</form>
@endsection
