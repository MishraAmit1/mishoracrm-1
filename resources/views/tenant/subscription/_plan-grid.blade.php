{{-- Shared plan picker: billing toggle + plan cards.
     Needs: $plans, $currentSub (nullable), $monthlyBillingEnabled.
     Used by the plans page and the subscription-expired page. --}}
<style>
.plans-wrap {
    max-width: 960px;
    margin: 0 auto;
